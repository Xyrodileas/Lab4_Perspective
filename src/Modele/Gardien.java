...
/**
 * Application du patron Memento : Utilisation de deux piles pour restauration
 * des �tats de l'image revenir � l'instant t-1 ou t+1
 * 
 */
class Gardien implements Serializable {
	...
	/**
	 * Constructeur par defaut de la classe Gardien Qui permet d'instancier un
	 * Originator Et deux piles qui vont permettre la restoration des �tats de
	 * l'image
	 */
	public Gardien() {
	...
	/**
	 * Methode qui permet d'ajouter un etat (Perspective) dans la pile afin de
	 * concerver les modifications de l'image et de pouvoir les restaurer par la
	 * suite
	 * 
	 * @param state
	 *            (Perspective)
	...
	/**
	 * Methode qui permet de retourner l'ancien etat de l'image dans le memento
	 * 
	 * @return Perspective
	 */
	...
	/**
	 * Methode qui permet de retourner un etat de l'image dans le memento
	 * 
	 * @return Perspective
	 */
